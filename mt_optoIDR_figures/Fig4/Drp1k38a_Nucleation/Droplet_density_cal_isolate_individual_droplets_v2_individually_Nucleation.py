...
params, covariance = curve_fit(nucleation_equation, time, rho_data, p0=[0.01,1,2]) #can provide initial guesses too p0=[.., ..., ..., ]
...
plt.scatter(time, rho_data, color='red', label='Data', alpha=0.6)
plt.plot(time, rho_fit, label='Fit', color='blue')
plt.xlabel('time(s)')
plt.ylabel('droplet density (ρ) (/um^2)')
plt.annotate(f'Nucleation rate (J(t0)) = {J:.5f}', xy=(0.5,0.3), xycoords='axes fraction')
plt.legend()
plt.show()
