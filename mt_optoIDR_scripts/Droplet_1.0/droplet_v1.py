...
o, n, m, l, q = condensate(r'C:\Users\sanja\OneDrive - The Pennsylvania State University\Research\Data_Analysis\PlayGround\droplets2.0', 
                           0.0488706004242 , 
                           intensities = ['Percentile', 93], 
                           timesteps = [1,100], 
                           zstacks = [1], 
                           channels = [2], 
                           windowsizes = [5], 
